...
function core:CreateCastbar(self)
  ...
  if(self.mystyle == "player") then
    ...
    castbar:SetWidth(cfg.units.player.castbar.width - cfg.units.player.castbar.height - 2)
    castbar:SetHeight(cfg.units.player.castbar.height)
    castbar:SetPoint("TOPLEFT", "oUF_LumenPlayer", "BOTTOMLEFT", cfg.units.player.castbar.height + 2, -cfg.frames.secondary.margin)
  ...
  elseif(self.mystyle == "target") then
    ...
    castbar:SetPoint("TOPRIGHT", self, "BOTTOMRIGHT", 0 , cfg.frames.main.height * 4 + cfg.frames.secondary.margin)
